...
public class SeckillSessionController {
    ...
    @GetMapping("/latestThreeSession")
    public R getLatestThreeSession() {
        List<SeckillSessionEntity> sessions = seckillSessionService.getLatestThreeSession();
    ...
    public R save(@RequestBody SeckillSessionEntity seckillSession) {
        System.out.println("seckillSession" + seckillSession);
