...
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `name`, `url`, `perms`, `type`, `icon`, `order_num`) VALUES (27, 1, '参数管理', 'sys/com.zyj.gulimall.geteway.config', 'sys:com.zyj.gulimall.geteway.config:list,sys:com.zyj.gulimall.geteway.config:info,sys:com.zyj.gulimall.geteway.config:save,sys:com.zyj.gulimall.geteway.config:update,sys:com.zyj.gulimall.geteway.config:delete', 1, 'com.zyj.gulimall.geteway.config', 6);
